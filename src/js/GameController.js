...
export default class GameController {
  ...
  onCellEnter(index) {
    ...
    if (this.state.positions.find((el) => el.position === index)) {
      ...
      const message = character.getTooltipText();
      ...
      if (document.querySelector('.selected-yellow') !== null
        ...
        if (lastCharacter.attackRangeIndex(indexLastClick, boardSize).some((e) => e === index)) {
    ...
    if (document.querySelector('.selected-yellow') !== null
      ...
      if (character.movementRangeIndex(indexLastClick, boardSize).some((e) => e === index)) {
        this.gamePlay.setCursor(cursors.pointer);
